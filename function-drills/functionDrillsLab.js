...
/*
  ...
  Inside, convert the arguments to be numbers (just in  icase strings get sentn)
...
let nameGreeting = nameCheck('tom brady')
...
const thatsOdd = number => {
  number%2 === 0 ? "That's not odd!" : 'That is odd indeed!'
}
